...
import sendBuyerMessage_function from "../Action/BuyerMessageAction"
...
class OwnerMessage extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            buyeremail: cookie.load("email"),
            buyername: cookie.load("name"),
    ...
    submitSend = e => {
        ...
        this.props.sendBuyerMessage_function(data)
    };
            ...
            <div>
                ...
                <div class="wrapper fadeInDown">
                    <div id="formContent">
                        ...
                        <div id="formFooter">
                            <p>{invalidAlert ? `Message successfully sent to ${this.state.restaurant}` : `Sending message to rest ${this.state.restaurant}!`} |
                            &nbsp;
                            <a href="/buyerhome">Go to Home</a>
                            </p>
...
const mapDispachToProps = dispatch => {
    return {
        sendBuyerMessage_function: (data) => dispatch(sendBuyerMessage_function(data)),
